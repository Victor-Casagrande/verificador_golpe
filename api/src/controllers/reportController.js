/**
 * Denúncias comunitárias e rankings públicos (acessibilidade e sites denunciados).
 * Rankings usam cache em memória (5 min) com deduplicação de requisições concorrentes.
 */
...
const getWorstAccessibilityRankings = async (req, res, next) => {
  try {
    ...
    const fetchPromise = reportService
